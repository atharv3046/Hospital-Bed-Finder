...
import { View, Text, TextInput, StyleSheet, TouchableOpacity, ActivityIndicator, Platform, ScrollView, KeyboardAvoidingView, Alert } from 'react-native';
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={s.scroll} style={{ backgroundColor: Colors.bg }}>
        ...
        >
          ...
          <Text style={s.title}>Hospital Finder</Text>
          <Text style={s.sub}>Access live bed availability dashboards</Text>
        </MotiView>
        ...
        >
          ...
          <TouchableOpacity
            style={[s.btn, (busy || !email || !pass) && s.btnDisabled]}
            onPress={onSignIn}
        ...
        <Text style={s.disclaimer}>
          Secure medical network access for patients & staff.
        </Text>
      </ScrollView>
...
const s = StyleSheet.create({
  ...
  forgot: { alignSelf: 'flex-end', marginBottom: Sp.lg },
  forgotText: { color: Colors.primaryLight, fontSize: 13, fontWeight: '700' },
